...
//           </TouchableOpacity>
//           <Text style={styles.headerTitle}>Barbara Moore</Text>
...
//                 style={{ marginRight: 6 }}
//               />
//               <Text style={[styles.menuText, { color: '#FF4D4F' }]}>
//                 Delete
//               </Text>
//             </TouchableOpacity>
//           </View>
...
//         >
//           <InfoItem icon="user" label="Name" value="Rajiv Sharma" />
//           <InfoItem icon="phone" label="Mobile No" value="+919876543210" />
//           <InfoItem
//             icon="map-pin"
//             label="Address"
//             value="Build 1/A, 101, Shree Krishna society, Waghle Estate, Thane – 400601 Maharashtra, India."
//           />
//           <InfoItem icon="briefcase" label="Occupation" value="Job" />
//           <InfoItem icon="grid" label="Type Of Work" value="IT Engineer" />
//           <InfoItem icon="dollar-sign" label="Monthly Income" value="₹ 30000" />
//           <InfoItem
//             icon="building"
//             label="Company Name"
//             value="ABC Contact Pvt Ltd"
//           />
//           <InfoItem
//             icon="flag"
//             label="Lead Status"
...
//           {(showAllServices ? allServices : allServices.slice(0, 2)).map(
//             (service, index) => (
...
//               <View style={[styles.statusTag, { backgroundColor: '#FFEFC3' }]}>
...
import { fetchLeadDetailsById } from '../services/common-services';
...
export default function LeadDetailsScreen({ route, navigation }) {
  ...
  useEffect(() => {
    const getLeadDetails = async () => {
      const response = await fetchLeadDetailsById(leadId);
      if (response) {
  ...
  return (
    <CustomeDetails
      ...
      infoItems={[
     { icon: 'user', label: 'Name', value: `${leadData.firstName} ${leadData.lastName}` },
        { icon: 'phone', label: 'Mobile No', value: leadData.mobileNo },
        { icon: 'map-pin', label: 'Address', value: `${leadData.addressLine1} ${leadData.addressLine2}`},
        { icon: 'briefcase', label: 'Occupation', value: leadData.occupationName },
        { icon: 'grid', label: 'Type Of Work', value: leadData.workType },
        {
          icon: 'dollar-sign',
          label: 'Monthly Income',
          value: `₹ ${leadData.monthlyIncome}`,
        },
        {
          icon: 'building',
          label: 'Company Name',
          value: leadData.organisationName,
        },
        {
          icon: 'flag',
          label: 'Lead Status',
          value: leadData.leadStatusName,
          isStatus: true,
        },
        // {
        //   icon: 'calendar',
        //   label: 'Next Meeting Date',
        //   value: leadData.nextMeetingDate,
        // },
        { icon: 'paperclip', label: 'Attachment', value: leadData.attachment },
      ]}
      services={leadData.services || []}
      history={leadData.history || []}
      onEdit={() => console.log('Edit Lead')}
      onDelete={() => console.log('Delete Lead')}
      onAddFollowUp={() => navigation.navigate('LeadFollowUp')}
      onAddService={() => navigation.navigate('LeadAddServices')}
    />
  );
}
