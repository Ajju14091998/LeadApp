...
//         {/* Leads Title */}
//         <Text style={styles.screenTitle}>Client</Text>
...
import { useNavigation } from '@react-navigation/native';
import { fetchAllClients,fetchclientDetailsById } from '../services/common-services';
...
export default function ClientListScreen() {
  ...
  const loadClients = async () => {
    ...
    const res = await fetchAllClients(fromDate, toDate);
  ...
  const handleDelete = id => {
    // You can add deleteClientById() logic here if backend supports it
